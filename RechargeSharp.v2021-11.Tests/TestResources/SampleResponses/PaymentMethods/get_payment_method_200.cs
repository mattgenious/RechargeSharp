...
{
    public static PaymentMethodService.GetPaymentMethodTypes.Response CorrectlyDeserializedJson()
    {
        return new PaymentMethodService.GetPaymentMethodTypes.Response()
        {
