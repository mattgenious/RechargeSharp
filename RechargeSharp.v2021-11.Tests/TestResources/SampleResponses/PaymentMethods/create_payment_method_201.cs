...
public class create_payment_method_201
{
    public static PaymentMethodsService.CreatePaymentMethodTypes.Response CorrectlyDeserializedJson()
    {
        return new PaymentMethodsService.CreatePaymentMethodTypes.Response(
            PaymentMethod: new PaymentMethodsService.CreatePaymentMethodTypes.PaymentMethod(
                Id: 123123,
                CustomerId: 2222222,
                ...
                Default: true,
                PaymentDetails: new PaymentMethodsService.CreatePaymentMethodTypes.PaymentDetails(
                    Brand: "visa",
                    ExpMonth: 4,
                    ExpYear: 2024,
                    Last4: "1234",
