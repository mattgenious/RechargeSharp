...
public static class change_a_subscription_next_charge_date_200
{
    public static SubscriptionService.ChangeSubscriptionsNextChargeDateTypes.Response CorrectlyDeserializedJson()
    {
        return new SubscriptionService.ChangeSubscriptionsNextChargeDateTypes.Response() {
