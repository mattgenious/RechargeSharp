...
public static class list_customers_200
{
    public static CustomerService.ListCustomersTypes.Response CorrectlyDeserializedJson()
    {
        ...
        {
            NextCursor = "eyJzdGFydGluZ19iZWZvcmVfaWQiOjcwNDgwODQ0LCJsYXN0X3ZhbHVlIjo3MDQ4MDg0NCwic29ydF9ieSI6ImlkLWRlc2MiLCJjdXJzb3JfZGlyIjoibmV4dCJ9",
            PreviousCursor = null,
            Customers = new[]
            {
                new CustomerService.SharedTypes.Customer()
                {
                    ...
                    ExternalCustomerId = new CustomerService.SharedTypes.ExternalCustomerId()
                    {
                        Ecommerce = "5624561795145"
                    },
