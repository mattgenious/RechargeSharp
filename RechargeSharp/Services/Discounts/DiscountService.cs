...
namespace RechargeSharp.Services.Discounts
{
    class DiscountService : RechargeSharpService
    {
        ...
        {
            var response = await GetAsync($"/discounts/{id}");
        ...
        {
            var response = await GetAsync($"/discounts?{queryParams}");
        ...
        public async Task<DiscountListResponse> GetDiscountsAsync(int page = 1, int limit = 50, string status = null, string discountType = null, string discountCode = null, DateTime? createdAtMin = null, DateTime? createAtMax = null, DateTime? updatedAtMin = null, DateTime? updatedAtMax = null)
        {
            ...
            return await GetDiscountsAsync(queryParams);
        }

        public async Task<CountResponse> CountDiscountsAsync()
        {
            var response = await GetAsync("/discounts/count");
        ...
        {
            var response = await PostAsync($"/addresses/{addressId}/apply_discount", $"{{ \"discount_id\":\"{discountId}\"}}");
        ...
        {
            var response = await PostAsync($"/addresses/{addressId}/apply_discount", $"{{ \"discount_code\":\"{discountCode}\"}}");
            return JsonConvert.DeserializeObject<AddressResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await PostAsync($"/addresses/{chargeId}/remove_discount", $"{{}}");
        ...
        {
            var response = await PostAsync($"/charges/{chargeId}/apply_discount", $"{{ \"discount_id\":\"{discountId}\"}}");
            return JsonConvert.DeserializeObject<ChargeResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await PostAsync($"/charges/{chargeId}/apply_discount", $"{{ \"discount_code\":\"{discountCode}\"}}");
            return JsonConvert.DeserializeObject<ChargeResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await PostAsync($"/charges/{chargeId}/remove_discount", $"{{}}");
            return JsonConvert.DeserializeObject<ChargeResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await PostAsync("/discounts", JsonConvert.SerializeObject(createDiscountRequest));
            return JsonConvert.DeserializeObject<DiscountResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await PutAsync($"/discounts/{id}", JsonConvert.SerializeObject(updateDiscountRequest));
            return JsonConvert.DeserializeObject<DiscountResponse>(
                await response.Content.ReadAsStringAsync());
        }
        ...
        {
            var response = await DeleteAsync($"/discounts/{id}");
        }
    }
