...
{
    public class WebhookCustomer : IEquatable<WebhookCustomer>
    {
        public bool Equals(WebhookCustomer other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((WebhookCustomer) obj);
        }
        ...
        public static bool operator ==(WebhookCustomer left, WebhookCustomer right)
        {
