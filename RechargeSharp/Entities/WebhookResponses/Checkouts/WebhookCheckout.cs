...
namespace RechargeSharp.Entities.WebhookResponses.Checkouts
{
    public class WebhookCheckout : IEquatable<WebhookCheckout>
    {
        ...
        [JsonProperty("payment_processor", NullValueHandling = NullValueHandling.Ignore)]
        public string PaymentProcessor { get; set; }

        [JsonProperty("payment_processor_customer_id", NullValueHandling = NullValueHandling.Ignore)]
        public string PaymentProcessorCustomerId { get; set; }

        [JsonProperty("payment_processor_transaction_id", NullValueHandling = NullValueHandling.Ignore)]
